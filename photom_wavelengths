...
key_name = os.path.join(path, 'YBphotometry_results_Key.csv')
...
key = ascii.read(key_name, delimiter=',')
...
while (YB1 < YB2) and not done:
    ...
    flag_key = [key[YB1+1]['8flag1'], key[YB1+1]['12flag1'], key[YB1+1]['24flag1'],
                key[YB1+1]['70flag1']]
    
    if flagcheck != flag_key and type(flagcheck[0]) == np.str_:
